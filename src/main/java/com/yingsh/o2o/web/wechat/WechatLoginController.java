package com.yingsh.o2o.web.wechat;

import com.yingsh.o2o.dto.UserAccessToken;
import com.yingsh.o2o.dto.WechatAuthExecution;
import com.yingsh.o2o.dto.WechatUser;
...
import com.yingsh.o2o.service.WechatAuthService;
import com.yingsh.o2o.util.wechat.WechatUtil;
 ...
 * https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx817d8aa2326bd40b&redirect_uri=http://uhi7um.natappfree.cc/o2o/wechatlogin/logincheck&role_type=1&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect
